...
<h1>  RACE AFRICA LEADERS FORUM </h1>
<p>RACE Africa Leaders Forum Is a fast-growing digital community enabling young social innovators and entrepreneurs access quality learning, networking, funding, Tech and Legal support opportunities.

</p>
<p>
Learn, engage and grow your Start-Up with hundreds of innovators like yourself on RALF
</p>
<a href="{{url('/ralfregister')}}" class="btn btn-primary">Join Now</a>
</div>
</div>
<div class="col-lg-6 col-md-12 p-0">
<div class="banner-item-image">
<img src="{{asset('assets/img/banner-image/banner1.jpg')}}" alt="banner-image">
</div>
</div>
</div>
</div>
...
<div class="bar"></div>
<p>Being an entrepreneur is a very lonely and tough journey.
Entrepreneurs need the right support system, industry connections, knowledge, mentorship and funding to give them a fighting chance at success. Our community provides a safe place for its members to learn, network, grow and access opportunities.</p>
<br>
<p>This community makes the entrepreneurial journey worthwhile.</p>
<br><br><br>
</div>
</div>
</div>
...
<section class="featured-boxes-area">
    ...
    <h2 align="center" style="font-weight: bolderb;">RALF Is a place to access...</h2>
    <div class="bar"></div>
    <br>
<div class="container">
...
<img style="width:100%s" src="assets/img/se.png">
</div>
<br><br><br><br><br><br>
<h3>Start-up education</h3>
<p>For  founders who are new to the world of start-ups and businesses, our platform will give you access to Entrepreneurship & Leadership Education Support: through Business Advisory, Mentorship & Coaching sessions, Webinars, Articles, Videos, Books, Courses and conferences our community will give you the opportunity to improve on your knowledge & skills as an entrepreneur</p>
</div>
</div>
<div class="col-lg-3 col-sm-6 col-md-6 p-0">
<div class="single-featured-box">
<div class="icon color-facd60">
<img style="width:100%s" src="assets/img/ts.png">
</div>
<br><br><br><br><br><br>
...
<img style="width:100%" src="assets/img/lg.png">
</div>
<br><br><br><br><br>
<h3>Legal support</h3>
...
<div class="single-featured-box">
<div class="icon">
<img style="width:100%" src="assets/img/Funding.png">
</div>
<br><br><br><br><br><br>
...
<td><ihhh class="flaticon-check-mark"></i></td>
</tr>
<tr>
...
<section class="ready-to-talk" style="background:#ff5304">
<div class="container">
<div class="ready-to-talk-content">
<h3>Ready to talk?</h3>
<p>Our team is here to answer all your questions about RACEAFRICA</p>
