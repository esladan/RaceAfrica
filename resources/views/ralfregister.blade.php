                ...
                <div class="signup-form" id="style-4-scrollbar">
                    ...
                    <form method="POST" class="register-form" action="{{ route('memberships.store') }}" id="register-form">
                        ...
                        <div class="form-radio">
                            <label for="are" class="radio-label">Are you a</label>
                            <div class="form-radio-item">
                                <input type="radio" name="are" id="student" checked>
                                <label for="student">Student</label>
                                <span class="check"></span>
                            </div>
                            <div class="form-radio-item">
                                <input type="radio" name="are" id="graduate">
                        ...
                        <div class="form-group">
                            <label for="do">Do you have any allergies or health challenge ?:</label>
